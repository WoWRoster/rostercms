...
define('ROSTER_VERSION', '2.9.9.1122');
 ...
 */
define('ROSTER_SVNREMOTE', 'http://www.wowroster.net/updater/roster/version_match.php');
define('ROSTER_UPDATECHECK', 'http://www.wowroster.net/updater/roster/version.txt');
