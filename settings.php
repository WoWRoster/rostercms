...
/**
 * Roster DEBUG Handler
 */
include (ROSTER_LIB . 'roster_debug.php');
$roster->debug = new roster_debug();
...
if  (function_exists('curl_init'))
{
	...
	$roster->api2 = new Client($roster->config['api_key_public'],$roster->config['api_key_private'],$roster->config['api_url_region'],$roster->config['api_url_locale'],ROSTER_URL.makelink('redirect'));
