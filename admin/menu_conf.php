...
//roster_add_js('templates/' . $roster->tpl->tpl . '/js/jquery/jquery-ui.min.js');
//roster_add_js('templates/' . $roster->tpl->tpl . '/js/menuconf.js');
...
$roster->tpl->assign_vars(array(
	...
	'BUTTON_GRID_WIDTH'     => (50*$arrayWidth+8),
	'BUTTON_GRID_HEIGHT'    => (50*$arrayHeight+8),
